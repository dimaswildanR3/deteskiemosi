...
def run():
    # Load SCRFD dari InsightFace
    print("Loading SCRFD face detector...")
    app = FaceAnalysis(
        name="buffalo_sc",       # model ringan SCRFD
        allowed_modules=["detection"],  # hanya deteksi, tidak perlu recognition
        providers=["CUDAExecutionProvider", "CPUExecutionProvider"]
    )
    app.prepare(ctx_id=0, det_size=(640, 640))
    print("✅ SCRFD berhasil diload!")
    ...
    while True:
        ...
        # Stage 1 — SCRFD deteksi semua wajah
        faces = app.get(frame)
