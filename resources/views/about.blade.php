        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h5 class="font-weight-bold">Laravel yolo</h5>
                            <p>yolo for Laravel.</p>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <p>Laravel yolo uses some open-source third-party libraries/packages, many thanks to the web community.</p>
                            <ul>
                                ...
                                <li><a href="https://startbootstrap.com/themes/sb-admin-2" target="_blank">yolo</a> - Thanks to Start Bootstrap.</li>
                            </ul>
                        </div>
                    </div>
